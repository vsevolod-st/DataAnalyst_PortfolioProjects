...
**Часть 2.** [Построить дашборд, содержащий информацию](https://datalens.ru/dqe5iqxiwiuuz?_theme=light):
* Обзор данных: количество объявлений, средняя площадь (общая, жилая, кухни), среднее количество комнат
* Динамика показателей: количество объявлений, средняя стоимость квартиры, средний срок экспозиции
